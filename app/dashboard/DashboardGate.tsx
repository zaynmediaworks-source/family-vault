...
export default function DashboardGate(){
  ...
  return <><DashboardAppV2/><PeriodExperience houses={activeHouses}/><InvestmentExperience houses={activeHouses}/><WealthExperienceV2 houses={activeHouses}/>{admin&&<Link href="/admin" className="floating-admin">🛡️ Admin</Link>}</>;
}
