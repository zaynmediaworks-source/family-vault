...
import WealthExperienceV3 from './WealthExperienceV3';
...
export default function DashboardGate(){
  ...
  return <><DashboardAppV2/><PeriodExperience houses={activeHouses}/><InvestmentExperience houses={activeHouses}/><WealthExperienceV3 houses={activeHouses}/><FeedbackNavLink/><BrandNavEnhancer/>{admin&&<Link href="/admin" className="floating-admin">🛡️ Admin</Link>}</>;
}
